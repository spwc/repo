...
def main_menu():
    ...
    add_dir(COLOR1(f'SEAN-PAULS TOOLBOX'), '', '', addon_icon, addon_fanart, COLOR1(f'***Welcome to {addon_name}***'), isFolder=False) 
    
    add_dir(COLOR1(f'***Wait 10 secs or so after selecting items in menus***'), '', '', addon_icon, addon_fanart, COLOR1(f'***Welcome to {addon_name}***'), isFolder=False) 
